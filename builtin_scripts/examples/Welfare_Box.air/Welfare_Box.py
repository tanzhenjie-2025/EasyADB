...
if __name__ == "__main__":
    ...
    try:
        ...
        kuaishou_pos = wait(Template(r"tpl1765285831946.png", record_pos=(-0.346, -0.628), resolution=(720, 1612)))


        if kuaishou_pos:
            touch(kuaishou_pos)

        make_money_pos = wait(Template(r"tpl1765285700753.png", record_pos=(0.197, 1.051), resolution=(720, 1612)))
        if make_money_pos:
            touch(make_money_pos)


        welfare_box_pos = wait(Template(r"tpl1765285756343.png", record_pos=(0.36, 0.992), resolution=(720, 1612)))
        if welfare_box_pos:
