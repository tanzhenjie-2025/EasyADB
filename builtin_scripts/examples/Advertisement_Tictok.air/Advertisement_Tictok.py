...
if __name__ == "__main__":
    ...
    try:
        ...
        tictok_pos = exists(Template(r"tpl1765684428505.png", record_pos=(0.339, -0.635), resolution=(720, 1612)))
        if tictok_pos:
            touch(tictok_pos)
            sleep(5)
        make_money_pos = exists(Template(r"tpl1765684495804.png", record_pos=(-0.006, 1.039), resolution=(720, 1612)))
        if make_money_pos:
        ...
        while count<5:
            count+=1
            advertisement_pos = exists(Template(r"tpl1765685085674.png", record_pos=(-0.053, 0.274), resolution=(720, 1612)))
        ...
        if advertisement_pos:
            ...
            keyevent("BACK")
            sleep(2)
            get_pos = exists(Template(r"tpl1765685253203.png", record_pos=(-0.001, 0.09), resolution=(720, 1612)))
            if get_pos:
                touch(get_pos)
                sleep(37)
                keyevent("BACK")
                sleep(5)
                valuation_pos = exists(Template(r"tpl1765685368480.png", record_pos=(-0.006, 0.212), resolution=(720, 1612)))
                if valuation_pos:
                    touch(valuation_pos)
                    sleep(1)
                    keyevent("BACK")
