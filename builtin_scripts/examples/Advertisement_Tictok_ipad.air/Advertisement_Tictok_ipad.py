...
#         此处输入代码
        ...
        tictok_pos = exists(Template(r"tpl1765683168799.png", record_pos=(-0.243, -0.614), resolution=(1600, 2560)))
        if tictok_pos:
            touch(tictok_pos)
            sleep(3)
        make_money_pos = exists(Template(r"tpl1765683235583.png", record_pos=(-0.001, 0.692), resolution=(1600, 2560)))
        if make_money_pos:
        ...
        while count<5:
            count+=1
            advertisement_pos = exists(Template(r"tpl1765682955020.png", record_pos=(-0.047, -0.056), resolution=(1600, 2560)))
        ...
        if advertisement_pos:
            ...
            agent_pos = exists(Template(r"tpl1765682674024.png", record_pos=(-0.008, 0.094), resolution=(1600, 2560)))
            if agent_pos:
                touch(agent_pos)
                ...
                sleep(5)
                keyevent("BACK")
            evaluation_pos = exists(Template(r"tpl1765682814921.png", record_pos=(-0.003, 0.094), resolution=(1600, 2560)))
            if evaluation_pos:
                touch(evaluation_pos)
    # -------------------- 步骤5：键盘中断捕获 --------------------
